  ...
  <div class="button-group">
    ...
    <div class="input-wrapper">
      <div class="input-group input-group-sm">
        ...
        <input type="number" id="input-${opts.mv.name}" class="form-control mv-color" min="${opts.mv.min}" max="${opts.mv.max}" step="${opts.mv.step}" value="${opts.mv.default}" aria-label="${opts.mv.name} input" aria-describedby="input-${opts.mv.name}-label">
      </div>
      <div class="input-group input-group-sm">
        <div class="input-group-prepend">
      ...
      <div class="input-group input-group-sm">
        ...
        <input type="number" id="input-${opts.cv.name}-Kc" class="form-control" min="${defaultParams.autoParams.KcMin}" max="${defaultParams.autoParams.KcMax}" step="${defaultParams.autoParams.KcStep}" value="${defaultParams.autoParams.KcDefault}" aria-label="${opts.cv.name} gain input" aria-describedby="input-${opts.cv.name}-Kc-label">
      </div>
      <div class="input-group input-group-sm">
        <div class="input-group-prepend">
          <span class="input-group-text" id="input-${opts.cv.name}-tau-label">tauI (s<sup>-1</sup>)</span>
        </div>
        <input type="number" id="input-${opts.cv.name}-tau" class="form-control" min="${defaultParams.autoParams.tauMin}" max="${defaultParams.autoParams.tauMax}" step="${defaultParams.autoParams.tauStep}" value="${defaultParams.autoParams.tauDefault}" aria-label="${opts.cv.name} tau input" aria-describedby="input-${opts.cv.name}-tau-label">
      </div>
    </div>
  </div>
  `;
