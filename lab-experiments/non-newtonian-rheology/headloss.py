...
fluids = [
    { 'name': 'Water', 'rho': 1.0, 'n': 1.0, 'K': 0.0089, 't0': 0.0 },
    { 'name': 'Ketchup', 'rho': 1.1, 'n': 0.228, 'K': 19.34, 't0': 0.0 },
    { 'name': 'Cornstarch', 'rho': 1.2, 'n': 1.75, 'K': 0.001, 't0': 0.0 }
]
...
for fluid in fluids:
    ...
    plt.plot(V, dhdL, label=fluid['name'])
