...
export const MIN_SCCM_FLOWRATE = (SIM_MODE === "adsorption") ? 5 : 100;
export const MAX_SCCM_FLOWRATE = (SIM_MODE === "adsorption") ? 200 : 2000;
export const SCCM_FLOW_STEP = (SIM_MODE === "adsorption") ? 5 : 50;
