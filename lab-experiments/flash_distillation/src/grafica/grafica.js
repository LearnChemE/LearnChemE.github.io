function defineGraficaJS() {
	 ...
	 * Title class.
	 */
	window.GTitle = function(parent, dim) {
	 ...
	 * Axis label class.
	 */
	window.GAxisLabel = function(parent, type, dim) {
		// The parent processing object
		this.parent = parent;
	 ...
	 * Axis class. 
	 */
	window.GAxis = function(parent, type, dim, lim, log) {
		// The parent processing object
		this.parent = parent;
	 ...
	 * Histogram class.
	 */
	window.GHistogram = function(parent, type, dim, plotPoints) {
		// The parent processing object
		this.parent = parent;
	 ...
	 */
	window.GLayer = function(parent, id, dim, xLim, yLim, xLog, yLog) {
		// The parent processing object
		this.parent = parent;
...
module.exports = defineGraficaJS();