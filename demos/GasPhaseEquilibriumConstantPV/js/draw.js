...
function drawGraphDist() {
  ...
  const getInnerFunc = calcAll();
  let result = getInnerFunc();
  //line(calcAll.fluid1LineXOut(z.distBY), calcAll().fluid1Y(z.distLX), calcAll().fluid1LineXOut(z.distTY), calcAll().fluid1Y(z.distRX));
