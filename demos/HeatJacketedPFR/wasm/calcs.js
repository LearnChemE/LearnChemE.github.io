...
async function createJacketedPFRModule(moduleArg = {}) {
  var moduleRtn;
...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('calcs.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('calcs.wasm', import.meta.url).href;
...
export default createJacketedPFRModule;
