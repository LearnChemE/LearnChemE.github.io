  ...
  return {
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin({
        title: "Operating a Chemostat (CSTR Bioreactor)",
        filename: "index.html",
        ...
        meta: {
          ...
          keywords:          "LearnChemE, chemical engineering, engineering, simulation, bioreactor, chemostat, CSTR, Monod kinetics",
          author:            "Sanath Kavatooru",
          "application-name": "Operating a Chemostat (CSTR Bioreactor)",
          description:       "A simulation of a chemostat (CSTR bioreactor) showing cell growth, substrate concentration, and production rate versus dilution rate."
        },
      }),
