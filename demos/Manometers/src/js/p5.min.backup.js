  ...
  return function a(o, s, l) {
    ...
    4: [function (N, e, F) {
      (function (c) {
        ...
        F.kMaxLength = r, (c.TYPED_ARRAY_SUPPORT = function () {
          ...
          if (r <= t) return 1;
          if (this === e) return 0;
          for (var a = (n >>>= 0) - (i >>>= 0), o = (r >>>= 0) - (t >>>= 0), s = Math.min(a, o), l = this.slice(i, n), u = e.slice(t, r), h = 0; h < s; ++h)
            if (l[h] !== u[h]) {
              a = l[h], o = u[h];
              break
        ...
        c.prototype.slice = function (e, t) {
          ...
          if (this === e && "function" == typeof Uint8Array.prototype.copyWithin) this.copyWithin(t, r, i);
            ...
            for (var a = n - 1; 0 <= a; --a) e[a + t] = this[a + r];
      ...
      (function (j, V) {
        ...
        e = this, t = function () {
          ...
          function L(t, e) {
            ...
            else if (n = typeof (i = e), null === i || "object" != n && "function" != n) P(t, e);
            else {
              var r = void 0;
              try {
                r = e.then
    ...
    10: [function (e, t, r) {
      ...
      function I(e, t, r, i, n, a) {
        ...
        for (null === n && (n = ce(t).a.b.c);
          (r = (i = ce(t)).a.b).a === n.a;) r.c !== n && (M(J(r), r), M(J(n), r)), i.f = t.f - r.f, i.d = D(e, i.f), t.b = !0, !o && B(e, t) && (L(r, n), O(t), c(n)), o = !1, t = i, n = r;
        t.b = !0, a && j(e, t)
      }
          ...
          if (v(i.a, n.a)) {
            if (i.a !== n.a) {
              ...
              if (0 <= a) {
                ...
                for (r.c[-(a + 1)] = null; 0 < r.a && null === r.c[r.d[r.a - 1]];) --r.a;
              N(e, J(n), i)
            }
      ...
      function G(e, t) {
        ...
        if (!v(s, e.a) && 0 <= b(s, e.a, u) || !v(l, e.a) && b(l, e.a, u) <= 0) {
          ...
          for (T(n.b), M(i.e, J(n)), o = (a = r = t).a.b.a;
            (a = fe(a)).a.b.a === o;);
      ...
      function j(e, t) {
        for (var r = ce(t);;) {
          ...
          if (i && (r.c ? (O(r), c(a), a = (r = ce(t)).a) : t.c && (O(t), c(n), n = (t = fe(r)).a)), n.a !== a.a)
            if (n.b.a === a.b.a || t.c || r.c || n.b.a !== e.a && a.b.a !== e.a) B(e, t);
            else if (G(e, t)) break;
        ...
        for (var r = (e.a = t).c; null === r.i;)
          if ((r = r.c) === t.c) {
            ...
            var a = ce(l = n.b),
              o = l.a;
            n = a.a;
            if (0 === b(o.b.a, i, o.a)) v((o = l.a).a, i) || v(o.b.a, i) || (T(o.b), l.c && (c(o.c), l.c = !1), M(i.c, o), V(r, i));
            else {
      ...
      function fe(e) {
        ...
        if (0 === l && 0 === n && 0 === o) {
          for (var n = [-2e150, -2e150, -2e150], a = [2e150, 2e150, 2e150], o = [], s = [], l = (r = this.b.c).e; l !== r; l = l.e)
            for (var u = 0; u < 3; ++u) {
              var h = l.g[u];
              h < a[u] && (a[u] = h, s[u] = l), h > n[u] && (n[u] = h, o[u] = l)
            }
          if (l = 0, n[1] - a[1] > n[0] - a[0] && (l = 1), n[2] - a[2] > n[l] - a[l] && (l = 2), a[l] >= n[l]) i[0] = 0, i[1] = 0, i[2] = 1;
          else {
        ...
        for (! function (e) {
          ...
          for (;;) {
            e: if (l = this.e, 0 === l.a) r = oe(l.b);
              else if (r = l.c[l.d[l.a - 1]], 0 !== l.b.a && (l = oe(l.b), y(l, r))) {
              r = l;
              break e
            }
        ...
        if (!this.n) {
          if (i = this.b, this.m)
            ...
            if (this.m) {
              ...
              for (i = this.b, r = !!this.l, l = !1, n = -1, o = i.a.d; o !== i.a; o = o.d)
                if (o.c)
                  for (l || (this.h && this.h(4, this.c), l = !0), s = o.a; r && (n !== (a = s.b.d.c ? 0 : 1) && (n = a, this.l && this.l(!!n, this.c))), this.k && this.k(s.a.d, this.c), (s = s.e) !== o.a;);
    ...
    11: [function (e, t, r) {
      ...
      try {
        r.GifWriter = function (y, e, t, r) {
          ...
          if (y[g++] = 255 & e, y[g++] = e >> 8 & 255, y[g++] = 255 & t, y[g++] = t >> 8 & 255, y[g++] = (null !== b ? 128 : 0) | n, y[g++] = a, y[g++] = 0, null !== b)
          ...
          this.addFrame = function (e, t, r, i, n, a) {
            ...
            if (0 === c && !f && 0 === h || (y[g++] = 33, y[g++] = 249, y[g++] = 4, y[g++] = c << 2 | (!0 === f ? 1 : 0), y[g++] = 255 & h, y[g++] = h >> 8 & 255, y[g++] = d, y[g++] = 0), y[g++] = 44, y[g++] = 255 & e, y[g++] = e >> 8 & 255, y[g++] = 255 & t, y[g++] = t >> 8 & 255, y[g++] = 255 & r, y[g++] = r >> 8 & 255, y[g++] = 255 & i, y[g++] = i >> 8 & 255, y[g++] = !0 === o ? 128 | u - 1 : 0, !0 === o)
          ...
          this.numFrames = function () {
            ...
            for (var p = 8, m = 0, v = n.length; m < v; ++m) {
              var y = n[m];
              if (0 === u && (u = s, c <= (f += d) && (d = 4 * l + 4 * w * (p - 1), f = h + (s + l) * (p << 1), p >>= 1)), y === o) f += 4;
              else {
                var g = x[a + 3 * y],
                  b = x[a + 3 * y + 1],
                  _ = x[a + 3 * y + 2];
          ...
          function (T) {
            ...
            function S(e, t, r) {
              for (;;) {
                ...
                if (s < 256) e.dest[e.destLen++] = s;
                  ...
                  for (i = _(e, h[s -= 257], c[s]), n = x(e, r), o = a = e.destLen - _(e, f[n], d[n]); o < a + i; ++o) e.dest[e.destLen++] = e.dest[o]
              }
            }
            ...
            function W(e, t, r) {
              ...
              if (this.tableName = e, this.fields = t, r)
                for (var a = Object.keys(r), o = 0; o < a.length; o += 1) {
                  var s = a[o],
                    l = r[s];
            ...
            var le = {
                parse: function (e, t) {
                  ...
                  if (r.format = s.parseUShort(), 12 === r.format) ! function (e, t) {
                    ...
                    for (var i = 0; i < r; i += 1)
                      for (var n = t.parseULong(), a = t.parseULong(), o = t.parseULong(), s = n; s <= a; s += 1) e.glyphIndexMap[s] = o, o++
                  }(r, s);
                  else {
                    ...
                    ! function (e, t, r, i, n) {
                      ...
                      for (var o = new se.Parser(r, i + n + 14), s = new se.Parser(r, i + n + 16 + 2 * a), l = new se.Parser(r, i + n + 16 + 4 * a), u = new se.Parser(r, i + n + 16 + 6 * a), h = i + n + 16 + 8 * a, c = 0; c < a - 1; c += 1)
                        for (var f = void 0, d = o.parseUShort(), p = s.parseUShort(), m = l.parseShort(), v = u.parseUShort(), y = p; y <= d; y += 1) 0 !== v ? (h = u.offset + u.relativeOffset - 2, h += v, h += 2 * (y - p), 0 !== (f = se.getUShort(r, h)) && (f = f + m & 65535)) : f = y + m & 65535, e.glyphIndexMap[y] = f
                    }(r, s, e, t, i)
                  }
                  return r
                },
            ...
            de.prototype.charToGlyphIndex = function (e) {
              ...
              if (r)
                for (var i = 0; i < r.length; i += 1)
                  for (var n = r.get(i), a = 0; a < n.unicodes.length; a += 1)
                    if (n.unicodes[a] === t) return i;
              return null
            ...
            ge.prototype.bindConstructorValues = function (e) {
              ...
              var s = (i = i || {}).xScale,
                l = i.yScale;
              if (i.hinting && n && n.hinting && (o = this.path && n.hinting.exec(this, r)), o) a = n.hinting.getCommands(o), e = Math.round(e), t = Math.round(t), s = l = 1;
              else {
            ...
            function Fe(e) {
              ...
              for (var i = 0, n = 0, a = 0; a < r.commands.length; a += 1) {
                ...
                else if ("L" === l.type) o = Math.round(l.x - i), s = Math.round(l.y - n), t.push({
                  name: "dx",
                  type: "NUMBER",
                  value: o
                }), t.push({
            ...
            var Be = {
              parse: function (e, t, r) {
                r.tables.cff = {};
                var i, n, a, o = Me(e, (i = e, n = t, (a = {}).formatMajor = se.getCard8(i, n), a.formatMinor = se.getCard8(i, n + 1), a.size = se.getCard8(i, n + 2), a.offsetSize = se.getCard8(i, n + 3), a.startOffset = n, a.endOffset = n + 4, a).endOffset, se.bytesToString),
                  s = Me(e, o.endOffset),
                ...
                var b = function (e, t, r, i) {
                  ...
                  var s = [".notdef"],
                    l = o.parseCard8();
                  if (0 === l)
                    for (var u = 0; u < r; u += 1) n = o.parseSID(), s.push(Ce(i, n));
                  else if (1 === l)
                    for (; s.length <= r;) {
                ...
                0 === c.encoding ? r.cffEncoding = new me(he, b) : 1 === c.encoding ? r.cffEncoding = new me(ce, b) : r.cffEncoding = function (e, t, r) {
                  var i, n = {},
                    ...
                    o = a.parseCard8();
                  if (0 === o)
                    for (var s = a.parseCard8(), l = 0; l < s; l += 1) n[i = a.parseCard8()] = l;
                  else {
                    if (1 !== o) throw new Error("Unknown encoding format " + o);
                    var u = a.parseCard8();
                    i = 1;
                    for (var h = 0; h < u; h += 1)
                      for (var c = a.parseCard8(), f = a.parseCard8(), d = c; d <= c + f; d += 1) n[d] = i, i += 1
                  }
                  return new me(n, r)
                  ...
                  switch (r.version = i.parseVersion(), r.italicAngle = i.parseFixed(), r.underlinePosition = i.parseShort(), r.underlineThickness = i.parseShort(), r.isFixedPitch = i.parseULong(), r.minMemType42 = i.parseULong(), r.maxMemType42 = i.parseULong(), r.minMemType1 = i.parseULong(), r.maxMemType1 = i.parseULong(), r.version) {
                    ...
                    case 2:
                      ...
                      for (var a = 0; a < r.numberOfGlyphs; a++)
                        if (r.glyphNameIndex[a] >= fe.length) {
                          var o = i.parseChar();
            ...
            function Ot(e, t, r) {
              ...
              if (e.numberOfContours = a.parseShort(), e._xMin = a.parseShort(), e._yMin = a.parseShort(), e._xMax = a.parseShort(), e._yMax = a.parseShort(), 0 < e.numberOfContours) {
                ...
                i = [];
                for (var h = 0; h < u; h += 1)
                  if (n = a.parseByte(), i.push(n), 0 < (8 & n))
                    for (var c = a.parseByte(), f = 0; f < c; f += 1) i.push(n), h += 1;
            ...
            function Rt(e) {
              ...
              for (var r = function (e) {
                ...
                for (var u = 0; u < n.length; ++u)
                  if (a = o, o = s, s = n[(u + 1) % n.length], o.onCurve) t.lineTo(o.x, o.y);
                  else {
                    var h = s;
                    a.onCurve || {
                      x: .5 * (o.x + a.x),
            ...
            function Dt(e, t) {
              if (t.isComposite)
                for (var r = 0; r < t.components.length; r += 1) {
                  ...
                  if (n.getPath(), n.points) {
                    var a = void 0;
                    if (void 0 === i.matchedPoints) a = Pt(n.points, i);
                    else {
              ...
              getFeatureTable: function (e, t, r, i) {
                ...
                if (n) {
                  for (var a, o = n.featureIndexes, s = this.font.tables[this.tableName].features, l = 0; l < o.length; l++)
              ...
              expandCoverage: function (e) {
                ...
                for (var t = [], r = e.ranges, i = 0; i < r.length; i++)
                  for (var n = r[i], a = n.start, o = n.end, s = a; s <= o; s++) t.push(s);
                return t
              }
            }).init = function () {
              ...
              for (var i = 0; i < e.length; i++)
                for (var n = e[i].subtables, a = 0; a < n.length; a++) {
                  var o = n[a],
              ...
              for (var i = [], n = this.getLookupTables(t, r, e, 1), a = 0; a < n.length; a++)
                for (var o = n[a].subtables, s = 0; s < o.length; s++) {
                  var l = o[s],
              ...
              for (var i = [], n = this.getLookupTables(t, r, e, 3), a = 0; a < n.length; a++)
                for (var o = n[a].subtables, s = 0; s < o.length; s++)
                  for (var l = o[s], u = this.expandCoverage(l.coverage), h = l.alternateSets, c = 0; c < u.length; c++) i.push({
                    sub: u[c],
                    by: h[c]
                  });
              return i
            }, St.prototype.getLigatures = function (e, t, r) {
              for (var i = [], n = this.getLookupTables(t, r, e, 4), a = 0; a < n.length; a++)
                for (var o = n[a].subtables, s = 0; s < o.length; s++)
                  for (var l = o[s], u = this.expandCoverage(l.coverage), h = l.ligatureSets, c = 0; c < u.length; c++)
              ...
              if (0 <= u) {
                for (var h = a.ligatureSets[u], c = 0; c < h.length; c++)
            ...
            Ft.prototype.exec = function (e, t) {
              ...
              if (!(2 < this._errorState)) {
                ...
                if (!i || i.ppem !== t) {
                  ...
                  var a = r.tables.cvt;
                  if (a)
                    for (var o = i.cvt = new Array(a.length), s = t / r.unitsPerEm, l = 0; l < a.length; l++) o[l] = a[l] * s;
                  else i.cvt = [];
              ...
              var r, i, n, a = t.ppem / t.font.unitsPerEm,
                o = a,
                s = e.components;
              if ($t.prototype = t, s) {
                var l = t.font;
            ...
            function Br(e) {
              var t, r, i, n, a, o, s, l, u, h, c, f, d, p, m = new Tr({
                ...
                y = [],
                g = se.getTag(v, 0);
              if (g === String.fromCharCode(0, 1, 0, 0) || "true" === g || "typ1" === g) m.outlinesFormat = "truetype", y = Nr(v, i = se.getUShort(v, 4));
              else if ("OTTO" === g) m.outlinesFormat = "cff", y = Nr(v, i = se.getUShort(v, 4));
              else {
    ...
    13: [function (e, t, u) {
      (function (n) {
        ...
        u.resolve = function () {
          ...
          for (var i = r(e.split("/")), n = r(t.split("/")), a = Math.min(i.length, n.length), o = a, s = 0; s < a; s++)
            if (i[s] !== n[s]) {
              o = s;
              break
            } var l = [];
          ...
          for (var t = e.charCodeAt(0), r = 47 === t, i = -1, n = !0, a = e.length - 1; 1 <= a; --a)
      ...
      ! function (e) {
        ...
        function b() {
          return this.bodyUsed = !1, this._initBody = function (e) {
            ...
            else if (n && o && s(e)) this._bodyArrayBuffer = g(e.buffer), this._bodyInit = new Blob([this._bodyArrayBuffer]);
            else {
        ...
        return function (e) {
          ...
          if (0 === e[0] && 0 === e[1] && 1 === e[2]) {
            ...
            for (var s = 0; s < h.length; s++)
              if (h[s].h === e[0] && h[s].s === e[1] && h[s].b === e[2]) {
                t = h[s].name;
                break
              } return t
        }([(l = t)[0], t[1], t[2]])
    ...
    17: [function (e, t, r) {
      ...
      o.default.prototype.describe = function (e, t) {
        ...
        var r = this.canvas.id;
        if ("fallback" === e) {
          if (this.dummyDOM.querySelector("#".concat(r + l))) this.dummyDOM.querySelector("#" + r + h).insertAdjacentHTML("beforebegin", '<p id="'.concat(r + u, '"></p>'));
          else {
        ...
        if ("label" === e) {
          if (this.dummyDOM.querySelector("#".concat(r + c))) this.dummyDOM.querySelector("#".concat(r + d)) && this.dummyDOM.querySelector("#".concat(r + d)).insertAdjacentHTML("beforebegin", '<p id="'.concat(r).concat(f, '"></p>'));
          else {
        ...
        var i = this.canvas.id;
        if ("fallback" === e) {
          if (this.dummyDOM.querySelector("#".concat(i + l))) this.dummyDOM.querySelector("#" + i + h) || this.dummyDOM.querySelector("#" + i + u).insertAdjacentHTML("afterend", '<table id="'.concat(i).concat(h, '"><caption>Canvas elements and their descriptions</caption></table>'));
          else {
        ...
        if ("label" === e) {
          if (this.dummyDOM.querySelector("#".concat(i + c))) this.dummyDOM.querySelector("#".concat(i + d)) || this.dummyDOM.querySelector("#" + i + f).insertAdjacentHTML("afterend", '<table id="'.concat(i + d, '"></table>'));
          else {
    ...
    22: [function (e, t, r) {
      ...
      n.default.ColorConversion = {}, n.default.ColorConversion._hsbaToHSLA = function (e) {
        ...
        if (0 === r) n = [i, i, i, e[3]];
          ...
          var a, o = 2 * i - (a = i < .5 ? (1 + r) * i : i + r - i * r),
            s = function (e, t, r) {
    ...
    23: [function (e, t, r) {
      ...
      e("./p5.Color"), e("../core/friendly_errors/validate_params"), e("../core/friendly_errors/file_errors"), e("../core/friendly_errors/fes_core"), c.default.prototype.alpha = function (e) {
        ...
        var i, n, a, o, s, l, u = this._colorMode,
          h = this._colorMaxes;
      ...
      var u = function () {
        ...
        return e = r, (t = [{
          ...
          value: function (e, t, r) {
            ...
            if (e === this.options.fallback) r(null, a[e][t]);
    ...
    36: [function (e, t, r) {
      ...
      var a = function () {
        function _(e, t, r) {
          ...
          if (e) e(this), _._checkForUserDefinedFunctions(this);
          else {
    ...
    39: [function (e, t, r) {
      ...
      l.default.Renderer = function (e, t, r) {
        ...
        else if (e *= a, t *= a, void 0 === r && void 0 === i) return e < 0 || t < 0 || e >= o.width || t >= o.height ? [0, 0, 0, 0] : this._getPixel(e, t);
        ...
        if ((this._doFill || this._doStroke) && void 0 !== e) {
          if ("string" != typeof e && (e = e.toString()), a = (e = e.replace(/(\t)/g, "  ")).split("\n"), void 0 !== i) {
            ...
            for (s = 0; s < a.length; s++) {
              for (u = "", c = a[s].split(" "), o = 0; o < c.length; o++)
                if (h = "".concat(u + c[o], " "), i < this.textWidth(h)) {
                  for (var b = c[o], _ = 0; _ < b.length; _++)
                    if (h = "".concat(u + b[_]), i < this.textWidth(h) && 0 < u.length) {
                      var x = u.slice(-1),
                        w = "\n" !== x && " " !== x;
    ...
    40: [function (e, t, r) {
      ...
      c.default.Renderer2D = function (e, t, r) {
        ...
        if (r instanceof c.default.Image) this.drawingContext.save(), this.drawingContext.setTransform(1, 0, 0, 1, 0, 0), this.drawingContext.scale(i._pixelDensity, i._pixelDensity), this.drawingContext.clearRect(e, t, r.width, r.height), this.drawingContext.drawImage(r.canvas, e, t), this.drawingContext.restore();
        else {
          var n = 0,
            a = 0,
            o = 0,
          ...
          if (i.imageData || i.loadPixels.call(i), "number" == typeof r) l < i.pixels.length && (o = a = n = r, s = 255);
          ...
          for (var u = 0; u < i._pixelDensity; u++)
            for (var h = 0; h < i._pixelDensity; h++) l = 4 * ((t * i._pixelDensity + h) * this.width * i._pixelDensity + (e * i._pixelDensity + u)), i.pixels[l] = n, i.pixels[l + 1] = a, i.pixels[l + 2] = o, i.pixels[l + 3] = s
        }
        ...
        if (u.beginPath(), void 0 === a) u.rect(t, r, i, n);
        else {
    ...
    41: [function (e, t, r) {
      ...
      f.default.prototype._setupPromisePreloads = function () {
        ...
        var t = function () {
          ...
          if (u)
            for (var o = n.length - 1; 0 <= o && !r && "function" == typeof n[o]; o--) r = t, t = n.pop();
    ...
    42: [function (e, t, r) {
      ...
      l.default.prototype.createCanvas = function (e, t, r) {
        ...
        if (this._setupDone || (i.dataset.hidden = !0, i.style.visibility = "hidden"), this._userNode) this._userNode.appendChild(i);
        else {
    ...
    46: [function (e, t, r) {
      ...
      s.default.prototype.beginContour = function () {
        ...
        if (s.default._validateParameters("endShape", arguments), this._renderer.isP3D) this._renderer.endShape(e, a, f, d, p, n);
        else {
            ...
            e(Object, "assign", {
              value: function (e, t) {
                ...
                for (r = 1; r < arguments.length; ++r)
                  for (i = Object(arguments[r]), a = s(i), l && Object.getOwnPropertySymbols && a.push.apply(a, Object.getOwnPropertySymbols(i).filter(u(i))), n = 0; n < a.length; ++n) o[a[n]] = i[a[n]];
                return o
              },
              configurable: !0,
              enumerable: !1,
    ...
    52: [function (e, t, r) {
      ...
      f.default.prototype.select = function (e, t) {
        ...
        var t = arguments[0];
        if (t instanceof f.default.Element && t.elt instanceof HTMLSelectElement) e = t, this.elt = t.elt;
        else if (t instanceof HTMLSelectElement) e = m(t, this), this.elt = t;
        else {
        ...
        return e.option = function (e, t) {
          ...
          if ("string" == typeof e)
            for (var t = 0; t < this.elt.length; t++) this.elt[t].value.toString() === e && (this.elt[t].disabled = !0, this.elt[t].selected = !1);
      ...
      f.default.MediaElement.prototype.addCue = function (e, t, r) {
        ...
        if (/^text\//.test(e.type) || "application/json" === e.type) f.default.File._createLoader(e, t).readAsText(e);
    ...
    57: [function (e, t, r) {
      ...
      function i(e, t) {
        ...
        var g, b, _, x, w = new Int32Array(m),
          S = new Int32Array(m),
          M = new Int32Array(m),
          T = new Int32Array(m),
          E = 0;
        for (! function (e) {
          ...
          for (g = 0; g < d; g++) {
            if (a = n = i = o = r = 0, (s = g - L) < 0) c = -s, s = 0;
            else {
              if (d <= s) break;
              c = 0
            }
      ...
      D._toPixels = function (e) {
        ...
        for (var t, r, i, n, a, o, s, l, u, h, c, f, d, p, m, v, y, g = D._toPixels(e), b = 0, _ = g.length ? g.length / 4 : 0, x = new Int32Array(_); b < _;)
      ...
      n.default.Image = function (e, t) {
        ...
        if (0 === t.lastChangeTime && (t.lastChangeTime = r), t.playing) {
          ...
          if (t.timeDisplayed >= i) {
            ...
            if (t.timeDisplayed = 0, t.lastChangeTime = r, t.displayIndex += n, t.loopCount = Math.floor(t.displayIndex / t.numFrames), null !== t.loopLimit && t.loopCount >= t.loopLimit) t.playing = !1;
            else {
    ...
    61: [function (e, t, r) {
      ...
      e("../color/p5.Color"), d.default.prototype.pixels = [], d.default.prototype.blend = function () {
        ...
        if (d.default._validateParameters("copy", t), 9 === t.length) i = t[0], n = t[1], a = t[2], o = t[3], s = t[4], l = t[5], u = t[6], h = t[7], c = t[8];
        else {
    ...
    62: [function (e, t, r) {
      ...
      e("../core/friendly_errors/validate_params"), e("../core/friendly_errors/file_errors"), e("../core/friendly_errors/fes_core"), y.default.prototype.loadJSON = function () {
        ...
        return this.httpDo(t, "GET", "table", function (e) {
          for (var t, r, i = {}, n = [], a = 0, o = null, s = function () {
            ...
            if (1 === i.currentState && i.escaped)
              if ('"' === t) '"' === e[a] ? (i.token += '"', a++) : (i.escaped = !1, i.currentState = 2);
              else {
                if ("\r" === t) continue;
                i.token += t
              }
        ...
        if (2 == arguments.length - o && "string" == typeof u && "object" === g(arguments.length <= 1 ? void 0 : arguments[1])) r = new Request(u, arguments.length <= 1 ? void 0 : arguments[1]), e = arguments.length <= 2 ? void 0 : arguments[2], t = arguments.length <= 3 ? void 0 : arguments[3];
        else {
          for (var h, c = "GET", f = 1; f < arguments.length; f++) {
            ...
            if ("string" == typeof d) "GET" === d || "POST" === d || "PUT" === d || "DELETE" === d ? c = d : "json" === d || "jsonp" === d || "binary" === d || "arrayBuffer" === d || "xml" === d || "text" === d || "table" === d ? i = d : h = d;
              ...
              else s = d instanceof y.default.XML ? (h = d.serialize(), "application/xml") : (h = JSON.stringify(d), "application/json");
        ...
        var r;
        for (var i in y.default.prototype._pWriters)
          if (y.default.prototype._pWriters[i].name === e) return r = new y.default.PrintWriter(e + this.millis(), t), y.default.prototype._pWriters.push(r), r;
        ...
        if (0 !== i.length)
          if (i[0] instanceof y.default.Renderer || i[0] instanceof y.default.Graphics) y.default.prototype.saveCanvas(i[0].elt, i[1], i[2]);
          else if (1 === i.length && "string" == typeof i[0]) y.default.prototype.saveCanvas(n, i[0]);
    ...
    74: [function (e, t, r) {
      ...
      function b(e) {
        ...
        for (var l, u, h = 3 === e.length && "M" === e[0][0] && "R" === e[1][0].toUpperCase() && "Z" === e[2][0].toUpperCase(), c = s, f = e.length; c < f; c++) {
          if (r.push(l = []), (u = e[c])[0] !== String.prototype.toUpperCase.call(u[0])) switch (l[0] = String.prototype.toUpperCase.call(u[0]), l[0]) {
              ...
              for (var y = 0, g = u.length; y < g; y++) l[y] = u[y];
          switch (l[0]) {
            case "Z":
              i = a, n = o;
              break;
      ...
      n.default.Font = function (e) {
        ...
        for (var u = 0; u < l.length; u++) {
          if (!(l[a = u].name && "space" === l[a].name || e.length === l.length && " " === e[a] || l[a].index && 3 === l[a].index))
            for (var h = m(l[u].getPath(t, r, i).commands), c = 0; c < h.length; c++)
              for (var f = p(h[c], n), d = 0; d < f.length; d++) f[d].x += o, s.push(f[d]);
        ...
        var n, a = i && i.renderer || this.parent._renderer,
          o = a.drawingContext;
    ...
    77: [function (e, t, r) {
      ...
      function a(e, t) {
        ...
        if (n = n.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","), 0 === t) i = "";
          ...
          if (t > i.length)
            for (var a = t - (i += -1 === r ? "." : "").length + 1, o = 0; o < a; o++) i += "0";
    ...
    79: [function (e, t, r) {
      ...
      E.default.prototype.cylinder = function (e, t, r, i, n, a) {
        ...
        if (!this._renderer.geometryInHash(a)) {
          var o = new E.default.Geometry(i, n, function () {
            for (var e = 0; e <= this.detailY; e++)
              for (var t = e / this.detailY, r = Math.PI * t - Math.PI / 2, i = Math.cos(r), n = Math.sin(r), a = 0; a <= this.detailX; a++) {
        ...
        if (this._assert3d("torus"), E.default._validateParameters("torus", arguments), void 0 === e) e = 50;
        else if (!e) return;
        if (void 0 === t) t = 10;
        else if (!t) return;
        ...
        if (!this._renderer.geometryInHash(n)) {
          var a = new E.default.Geometry(r, i, function () {
            for (var e = 0; e <= this.detailY; e++)
              for (var t = e / this.detailY, r = 2 * Math.PI * t, i = Math.cos(r), n = Math.sin(r), a = 1 + d * i, o = 0; o <= this.detailX; o++) {
        ...
        if (!this.geometryInHash(f)) {
          var d = new E.default.Geometry(2, 2, function () {
            this.vertices.push(new E.default.Vector(e, t, r)), this.vertices.push(new E.default.Vector(i, n, a)), this.vertices.push(new E.default.Vector(o, s, l)), this.vertices.push(new E.default.Vector(u, h, c)), this.uvs.push(0, 0, 1, 0, 1, 1, 0, 1), this.strokeIndices = [
              [0, 1],
              [1, 2],
              [2, 3],
              [3, 0]
    ...
    80: [function (e, t, r) {
      ...
      f.default.prototype.orbitControl = function (e, t, r) {
        if (this._assert3d("orbitControl"), f.default._validateParameters("orbitControl", arguments), this.mouseX < this.width && 0 < this.mouseX && this.mouseY < this.height && 0 < this.mouseY) {
          ...
          if (this._mouseWheelDeltaY !== this._pmouseWheelDeltaY && (0 < this._mouseWheelDeltaY ? this._renderer._curCamera._orbit(0, 0, 0.1 * r * n) : this._renderer._curCamera._orbit(0, 0, - 0.1 * r * n)), this.mouseIsPressed)
                ...
                for (var r, i, n = "", a = [], o = 0; o < t.length; ++o) {
                  ...
                  if (0 !== l.length) switch (n) {
                    ...
                    case "facet normal":
                      ...
                      break;
                    case "vertex":
                      if ("vertex" === l[0]) i = new S.default.Vector(parseFloat(l[1]), parseFloat(l[2]), parseFloat(l[3])), e.vertices.push(i), e.uvs.push([0, 0]), a.push(e.vertices.indexOf(i));
                      else {
    ...
    85: [function (e, t, r) {
      ...
      h.default.Geometry = function (e, t, r) {
        ...
        this.faces.length = 0;
        for (var e, t, r, i, n = this.detailX + 1, a = 0; a < this.detailY; a++)
          for (var o = 0; o < this.detailX; o++) t = (e = a * n + o) + 1, r = (a + 1) * n + o + 1, i = (a + 1) * n + o, this.faces.push([e, t, i]), this.faces.push([i, t, r]);
        return this
        ...
        for (var n = 0; n < i.length; ++n)
          for (var a = i[n], o = this._getFaceNormal(n), s = 0; s < 3; ++s) {
            t[a[s]].add(o)
          }
    ...
    86: [function (e, t, r) {
      ...
      "undefined" != typeof Float32Array && (n = Float32Array, R = function (e) {
        ...
        else if (e instanceof P.default.Matrix) t = e.mat4;
        else if (R(e)) t = e;
        else {
